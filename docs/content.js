const CONTENT = {
  TranscrA: [
    ...
    `<p>I remember that day clearly because it was raining heavily and I was driving to work at around seven-thirty in the morning. I was heading down Main Street when I saw a blue sedan—possibly a Honda or maybe a Toyota—speed through the intersection without stopping at the red light. I heard a loud crash, so I pulled over to see what had happened. The driver of the blue car got out and started yelling, but I couldn't make out what he was saying because of the rain and the general commotion.</p>`,

    `<p>- It was raining heavily.<br>
          - The narrator was driving to work at around 7:30 a.m.<br>
          - They were heading down Main Street.<br>
          - They saw a blue sedan, possibly a Honda or Toyota, speed through an intersection without stopping at a red light.<br>
          - They heard a loud crash and pulled over to see what had happened.<br>
          - The driver of the blue car got out and started yelling.<br>
          - The narrator could not understand what the driver was saying because of the rain and general commotion.<br>
          </p>`
  ],
  ...
  TranscrB: [
    ...
    `<p>The patient presented today with a three-day history of chest pain that worsens with deep inspiration and coughing. On examination, there was tenderness of the intercostal muscles on the right side. Vital signs were as follows: blood pressure 120/80 mmHg, heart rate 72 beats per minute, and temperature 98.6°F. The clinical picture is most consistent with costochondritis rather than a more serious condition such as a cardiac event.</p>`,

    `<p>- Patient has a three-day history of chest pain.  <br>
        - Chest pain worsens with deep inspiration and coughing.  <br>
        - Physical examination shows tenderness of the intercostal muscles on the right side.  <br>
        - Vital signs: blood pressure 120/80 mmHg, heart rate 72 bpm, temperature 98.6°F.  <br>
        - Clinical picture is most consistent with costochondritis.  <br>
  ...
  TranscrC: [
    ...
    `<p>We need to review the quarterly numbers and assess our position against the project timeline. Although we have been behind schedule, Sarah's team has made significant progress on the user interface redesign. Mike has reported that the database issues are now mostly resolved, which puts us in a much better position than we were in last month. However, we still need to determine the budget allocation for next quarter and consider hiring one or two additional developers if we want to meet the planned December deadline.</p>`,

    `<p>- Review the quarterly numbers and assess position relative to the project timeline<br>
          - Project has been behind schedule  <br>
          - Sarah's team has made significant progress on the user interface redesign  <br>
          - Mike reports the database issues are now mostly resolved  <br>
          - Current situation is much better than last month  <br>
          - Budget allocation for next quarter still needs to be determined  <br>
          - Hiring one or two additional developers is being considered to meet the planned December deadline</p>`
  ]
};
